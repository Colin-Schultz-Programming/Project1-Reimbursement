...
asyncFetch("http://localhost:8080/Reimbursement/Pending.json", renderPendingTable);
asyncFetch("http://localhost:8080/Reimbursement/Resolved.json", renderResolvedTable);
